...
<div class="col m12 s12">
	<a style="font-size: 20pt;" class="right" href="?menu=operacao&acao=incluir">Novo registro</a>
</div>
...
<div>
	<table class="bordered responsive-table col s12 m12">
		<thead>
			<tr>
				<th><a href="?menu=operacao&acao=listar&ord=1">Código</a></th>
				<th><a href="?menu=operacao&acao=listar&ord=2">Nome</a></th>
				<th>Ação</th>
			</tr>
		</thead>
		...
		?>
			<tr class="hoverable">
				<td><?php echo $reg->OPE_CODIGO ?></td>
				<td><?php echo $reg->OPE_NOME ?></td>
				<td><a href="?menu=operacao&acao=alterar&id=<?php echo $reg->OPE_CODIGO;?>">Alterar</a>
				&nbsp;&nbsp;&nbsp;&nbsp;
				<a style="color: #D50000; font-weight: bolder;" href="javascript:if(confirm('Confirma a exclusão deste registro?')){
				location='?menu=operacao&acao=excluir&id=<?php echo $reg->OPE_CODIGO?>';}">Excluir</a>
				</td>
			</tr>
			<?php
			}?>
