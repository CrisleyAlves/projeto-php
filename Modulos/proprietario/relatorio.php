<?php
	...
	$pdf->Cell(277,10,"RELATORIO DOS PROPRIETARIOS",1,1,"C",1);

	$pdf->SetTextColor(000,000,000);
	$pdf->Ln(5); // da um espaço entre o que estiver a cima e o próximo conteúdo
	$pdf->CELL(15,10,"COD",1,0,"C",0);
	$pdf->CELL(80,10,"NOME",1,0,"C",0);
	$pdf->CELL(31.6,10,"CPF",1,0,"C",0);
	$pdf->CELL(31.6,10,"RG",1,0,"C",0);
	$pdf->CELL(80,10,"EMAIL",1,0,"C",0);
	$pdf->CELL(39,10,"CONTATO",1,1,"C",0);
	...
	while($reg = $res->FetchNextObject()){
		$pdf->CELL(15,10,$reg->PRO_CODIGO,1,0,"C",0);
		$pdf->CELL(80,10,$reg->PRO_NOME,1,0,"C",0);
		$pdf->CELL(31.6,10,$reg->PRO_CPF,1,0,"C",0);
		$pdf->CELL(31.6,10,$reg->PRO_RG,1,0,"C",0);
		$pdf->CELL(80,10,$reg->PRO_EMAIL,1,0,"C",0);
		$pdf->CELL(39,10,$reg->PRO_CONTATO,1,1,"C",0);
		$linhas++;
	}
	$pdf->Ln(3);
	$pdf->CELL(100,5,"TOTAL DE REGISTROS LISTADOS: ".$linhas,0,0,"L",0);
	$pdf->CELL(90,5,"Data-Hora: ".date("d/m/Y-H:i:s"),0,1,"R",0);
	$pdf->Output("relatorio-proprietario.pdf");
	redireciona("http://localhost/trabalho-adilso/Projeto/Projeto/modulos/proprietario/relatorio-proprietario.pdf");
?>